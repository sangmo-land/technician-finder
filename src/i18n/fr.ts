export default {
  ...
  filters: {
    ...
    availableNow: "Maintenant",
    availableToday: "Aujourd'hui",
    availableWeek: "Cette semaine",
  },
  ...
  admin: {
    ...
    deleteSuccess: "{{name}} a été supprimé.",
    ...
    resetSuccess: "Les données ont été réinitialisées.",
    resetFailed: "Échec de la réinitialisation des données.",
    searchPlaceholder: "Rechercher par nom, compétence ou lieu…",
    searchResults: "{{count}} résultats trouvés",
    noSearchResults: "Aucun résultat",
    noSearchResultsMessage: "Essayez un autre terme de recherche.",
    avgRating: "Moy. Note",
    noAccess:
    ...
    you: "Vous",
    tabSkills: "Métiers",
    skillsTitle: "Gestion des métiers",
    skillsDesc: "Gérer les catégories de compétences disponibles",
    addSkill: "Ajouter un métier",
    skillNameEn: "Nom du métier (anglais)",
    skillNameFr: "Nom du métier (français)",
    defaultSkill: "Par défaut",
    customSkill: "Personnalisé",
    deleteSkillTitle: "Supprimer le métier",
    deleteSkillMessage: 'Supprimer "{{name}}" de la liste des métiers ?',
    skillAdded: '"{{name}}" a été ajouté.',
    skillDeleted: '"{{name}}" a été supprimé.',
    skillExists: "Ce métier existe déjà.",
    currentSkills: "Métiers actuels",
    cannotDeleteDefault:
      "Les métiers par défaut ne peuvent pas être supprimés.",
  },
  ...
  form: {
    ...
    bioLabelFr: "Bio / Description en français (Facultatif)",
    bioPlaceholderFr: "Décrivez les spécialités en français...",
  ...
  profile: {
    ...
    technicianBadgeDesc: "Votre profil est visible par les clients",
    accountTypeTechnician: "Technicien",
    ...
    bioFr: "Bio / Description en français (Optionnel)",
    bioFrPlaceholder: "Décrivez vos spécialités en français...",
